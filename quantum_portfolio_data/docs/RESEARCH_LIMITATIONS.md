...
2. Research run bị chặn cho đến khi có lịch sử listing/delisting HOSE và corporate-action provenance hợp lệ. Index membership chỉ bắt buộc khi cấu hình chọn universe theo chỉ số; nó không thay thế lịch sử toàn HOSE. Chuỗi giá thật đơn thuần không đủ để kiểm soát survivorship bias.
